    ...
    <div class="space-y-6 max-w-5xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-slate-800 rounded-xl shadow-lg p-6 border border-slate-700 relative overflow-hidden">
                <!-- Detalhe decorativo -->
                <div class="absolute top-0 right-0 w-32 h-32 bg-[#D85A1A]/10 rounded-full blur-2xl -mr-10 -mt-10 pointer-events-none"></div>
                ...
                <div v-else class="flex items-baseline space-x-2 mt-2 mb-4">
                    ...
                    <span class="text-4xl font-extrabold" :class="(balance || 0) < 0 ? 'text-red-400' : 'text-green-400'">
                ...
                <div class="flex space-x-3">
                    <NuxtLink to="/meu-saldo" class="bg-[#D85A1A] hover:bg-[#B94814] text-white px-4 py-2 rounded font-medium transition-colors text-sm">
            ...
            <div class="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
                ...
                <ul class="space-y-3 text-slate-400 text-sm">
                    <li class="flex items-start">
                        ...
                        <span>Seu saldo é utilizado para inscrições em torneios e compra de produtos.</span>
                    </li>
                    <li class="flex items-start">
                        <span class="text-[#D85A1A] mr-2 mt-0.5">•</span>
                    ...
                    <li class="flex items-start">
                        <span class="text-[#D85A1A] mr-2 mt-0.5">•</span>
                        <span>Você pode visualizar o seu comprovante no link ao lado.</span>
                    </li>
                </ul>
            </div>
